...
**Gradescope Question 1:** What is the name of a systemd service running on your system? What does it do?
...
**Gradescope Question 2:** What is the difference between `systemctl reload yourservice` and `systemctl restart yourservice?`
...
**Gradescope Question 3:** What command did you run to kill the service?
...
**Gradescope Question 4:** Upload your fully featured `toy.service` file to Gradescope.
