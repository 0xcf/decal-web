...
Let’s narrow it down to services for now. Run `systemctl --type=service`. Now you can see a list of all services running on your computer. Each of these services is a daemon running in the background. Do you see any familiar services running? (Exercise 1) What is a service running on your system?
...
(Exercise 2) What is the difference between `systemctl reload yourservice` and `systemctl reload restart yourservice`?
...
(Exercise 4) Upload your fully featured `toy.service` file to Gradescope.
