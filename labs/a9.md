...
5. Repeat step 5, but additionally this time sign the encrypted file, and verify the
   signature on the file when you recieve one, using the appropriate `gpg`
   options. [^extracredit]

6. The DeCal staff have uploaded a few
   [files](https://raw.githubusercontent.com/0xcf/decal-labs/master/a9/) called directions to help you
