...
headaches. As always, make sure to take advantage of Piazza, Slack, and other
...
**If you run into significant issues during installation, you may find this lab to be the longest of the semester.** To avoid unnecessary headaches, please consult with staff if you're stuck on an issue that isn't documented in this lab and we can assist. If you find that this is taking more than 6 hours or you have had to restart more than twice, let us know as well (it shouldn't take this long).
