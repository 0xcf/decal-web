...
(Exercise 1) What is the difference between `systemctl reload yourservice` and `systemctl reload restart yourservice`?
(Exercise 2) What determines the specific behavior of `systemctl reload yourservice` and `systemctl reload restart yourservice`?
