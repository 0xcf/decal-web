...
Linuxdistributions all share the Linux kernel. For that same reason, you won't be able to run MacOS or Windows in a container.
...
What is this doing? We specify a base image `ubuntu:bionic` (the bionic version of ubuntu).
