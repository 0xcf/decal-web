...
Lecture: Thursday 2019-09-19

Lab Released: Monday 2019-09-23

Lab Due: Monday 2019-09-30
...
### Workflow
This lab should be completed on your student VM. You should have received an email with instructions and credentials for connecting your VM. Before starting the lab, `ssh` into your student VM.
...
1. Compiling and packaging
  ...
  a. Will we still be able to run "hellopenguin" from any directory if we packaged it into "/usr/share" instead of "/usr/bin"?

  b. What is your rationale for the previous answer?

2. Debugging

  a. What package was missing after trying to install ocfspy?

  b. What is the password that ocfspy outputs after fixing the dependency problem?
