...
The checkoff form is [here](https://goo.gl/forms/8QMYcjnHHQQT426A3). Please double-check that you've completed the Gitolite section successfully, as we will be running `ssh gitolite3@[username].decal.xcf.sh info` to
