...
6. `b8/file9.txt`: These files are currently owned by another user. Choose any method to make the files readable to you and unreadable to the previous owner.

[GOOGLE FORM I HAVE YET TO CREATE](link)
