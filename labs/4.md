...
layout: lab
facilitator: Michael Lisano, Albert Ye
nav_exclude: true
---
...
Now, accessing http://[yourusername].decal.xcf.sh:80 should now give you a connection refused error and your webserver will only be accessible via http://[yourusername].decal.xcf.sh:420.
...
**Question 3:** Upload a screenshot of your browser accessing the nginx webserver at http://[yourusername].decal.xcf.sh:420.
