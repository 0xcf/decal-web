...
**Answer these questions on Gradescope**, the assignment should be up already.
If you haven't been added to the class yet, let a head facilator know!

First we'll do some general questions to get you comfortable with working in the
shell before we get to the real lab assignment. Feel free to use Google and work
in a terminal (where applicable) to verify your conjectures.
