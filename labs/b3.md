...
Skeleton code for both bash and python can be found [here](https://github.com/0xcf/decal-labs/tree/master/b3).Once you're done, fill out the check-off form [here](https://goo.gl/forms/X86seA7HdfNWAzR93).
