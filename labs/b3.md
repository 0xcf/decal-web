...
Skeleton code for both `bash` and `python` formats can be found at
...
- [Here][15] you can read more about `bash` redirections
- [Here][16] you can see `python` used in a system administration context to
...
[15]: https://www.gnu.org/software/bash/manual/html_node/Redirections.html
[16]: https://github.com/0xcf/decal-utils/blob/master/checkoff
